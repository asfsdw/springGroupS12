	...
	<div class="container text-center">
		...
		<form name="productUpdateForm" method="post" enctype="multipart/form-data" class="was-validated">
			<table class="table table-bordered">
				<tr>
					<th>등록자</th>
					<td><input type="text" id="nickName" name="nickName" value="${vo.nickName}" class="form-control" /></td>
					<th>상품명</th>
					<td><input type="text" id="title" name="title" value="${vo.title}" class="form-control" /></td>
					<th>상품대표이미지</th>
				...
				<tr>
					...
					<th>상품가격</th>
					<td><input type="number" id="price" name="price" value="${vo.price}" class="form-control" /></td>
					<th>상품수량</th>
		...
		<input type="button" value="돌아가기" onclick="location.href='${ctp}/admin/ProductList'" class="btn btn-warning btn-sm" />
		<p><br/></p>
	</div>
